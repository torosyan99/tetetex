...
new Swiper(casesSwiper, {
  ...
  on: {
    init() {
      casesCurrent.innerHTML = `<span class="slide-current__active"> 1 </span> <div class="cases__line"></div> ${this.slides.length}`
    },
    slideChange() {
      casesCurrent.innerHTML = `<span class="slide-current__active"> ${this.activeIndex + 1}</span>  <div class="cases__line"></div> ${this.slides.length}`
